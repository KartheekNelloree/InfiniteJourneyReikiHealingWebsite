      ...
      <section className="py-24 px-6">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16">
          ...
          <div className="space-y-8">
            ...
            {[
              { icon: '📍', label: 'Address', value: '123 Serenity Lane, Healing District\nMumbai, Maharashtra 400001, India' },
              { icon: '📞', label: 'Phone', value: '+91 98765 43210' },
              { icon: '✉️', label: 'Email', value: 'hello@anandareiki.com' },
              { icon: '🕐', label: 'Working Hours', value: 'Mon–Fri: 9am – 7pm\nSat: 10am – 5pm\nSun: By Appointment' },
            ].map((item, i) => (
            ...
            <div className="rounded-xl overflow-hidden h-48 flex items-center justify-center" style={{ background: 'linear-gradient(135deg, var(--purple-light), var(--blue-light))' }}>
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600 font-medium">Ananda Reiki Healing Center</p>
