...
const courses = [
  {
    ...
    mode: 'Online / Offline',
    price: '₹5,000',
    includes: ['Usui Reiki Level 1 Attunement', 'Printed Manual & Certificate', 'Self-healing hand positions', '21-day cleanse guidance', 'Lifetime email support'],
  },
  {
    title: 'Reiki Level 2',
...
const faqs = [
  ...
  { q: 'Are the certificates internationally recognized?', a: 'Yes. Our certificates are issued under the Usui Shiki Ryoho lineage and are recognized by major international Reiki associations worldwide.' },
]
    ...
    <div className="pt-20">
      ...
      <div className="page-hero">
        ...
        <p className="mt-4 text-gray-500 max-w-xl mx-auto">
          Certified programs for every level — from curious beginners to aspiring Reiki Masters.
        </p>
      </div>
      ...
      <section className="py-16 px-6">
        <div className="max-w-3xl mx-auto text-center">
          <p className="text-gray-500 leading-relaxed text-base">
            Our Reiki courses are structured along the traditional Usui Shiki Ryoho system. Each level builds on the previous, deepening your connection to universal life energy. All courses include attunement, printed materials, and a certificate recognized by international Reiki associations.
          </p>
        </div>
      </section>
