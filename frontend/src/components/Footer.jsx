      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-xs tracking-widest uppercase mt-1 mb-4" style={{ color: 'var(--purple-light)' }}>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              <li className="flex items-start gap-2">
                ...
                123 Serenity Lane, Healing District, Mumbai, India
              </li>
        ...
        <div className="border-t border-white/10 mt-12 pt-6 flex flex-col md:flex-row justify-between items-center text-sm text-gray-500 gap-2">
          <p>© {new Date().getFullYear()} Ananda Reiki Healing Center. All rights reserved.</p>
